...
description: Understand React Server Components (RSC) - the new architecture that allows components to run on the server. Learn about RSC payload, streaming with Suspense, and how it differs from traditional SSR.
cover:
