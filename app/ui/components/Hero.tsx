    ...
    >
      ...
      <div className="w-full max-w-[1400px] mx-auto relative z-10">
        <h1 className="font-black mb-8 leading-[1.1] overflow-visible">
          ...
          <span
            className="block text-[clamp(60px,10vw,140px)] text-stroke opacity-0 animate-slide-in"
            style={{ animationDelay: '0.2s' }}
          >
            Frontend
          </span>
          <span
            className="block text-[clamp(60px,10vw,140px)] text-gradient opacity-0 animate-slide-up"
