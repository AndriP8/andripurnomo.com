        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr] gap-16 items-start">
            ...
            <aside className="hidden lg:block">
              <TableOfContentsClient containerSelector=".article-content" />
            </aside>
